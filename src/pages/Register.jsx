  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.error('Google login error:', result.errorCode, result.error);
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="social-login">
          <button onClick={handleGoogleLogin} disabled={loading} className="social-btn google">
          ...
          <button onClick={handleGitHubLogin} disabled={loading} className="social-btn github">
